...
${rulesComparisonBlock}${specialWorkingHoursBlock}${workerCategoryBlock}${companySizeBlock}
[요구사항]
1. 종합 위험도 (위험 / 주의 / 양호) 참고 등급 - 확정적 법적 판단이 아님을 표현으로 드러낼 것 ("~일 가능성이 있습니다" 등)
2. 근로기준법 등 위반 소지가 있거나 독소 조항으로 볼 여지가 있는 부분 식별 (특수 근로시간제 요건 미비, 근로자 유형별 차등 규정 포함)
