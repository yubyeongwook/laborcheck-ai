...
[간주근로자(사업장 밖 간주근로시간제 - 근로기준법 제58조) 자문 규칙]:
1. 마트 상주직, 외근 영업직, 출장근로자 등 사업장 밖에서 일하는 [간주근로자] 관련 질문 시, 근로기준법 제58조에 따른 정밀 자문 및 특약 조항을 작성해라:
   - 🏢 **사업장 밖 간주근로시간제 조항**: *"사업장 밖에서 근로하여 근로시간을 산정하기 어려운 경우 소정근로시간(1일 8시간) 또는 노사 서면 합의로 정한 시간을 근로한 것으로 본다(간주한다)"* 는 법정 조항
   - 📜 서면 합의로 정한 고정 연장수당 산정 및 유통/마트 상주 간주근로자 특약 작성
2. 간주근로시간제 특약을 취업규칙 제3장(근로시간) 및 근로계약서에 포함시켜 출퇴근 시간 시비 및 연장근로 분쟁을 법적으로 사전 방어해라.
