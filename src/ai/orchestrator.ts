...
[유통/마트 도급·위탁 특수근로 & 계약 자동종료 자문 규칙]:
1. 유통업, 아웃소싱, 파견, 마트 상주 근로 관련 질문 시, 대화를 통해 아래 특수 계약 조건이 있는지 확인하고 취업규칙 및 계약서 조항을 작성해라:
   - 🏬 **급여 분할 지급 구조**: 급여의 절반은 유통회사에서 주고, 나머지 절반은 마트(사용처)에서 직접 또는 수당으로 지급하는 분할 임금 조항
   - 📜 **마트 계약 만료 시 근로계약 자동 종료 특약**: *"유통회사와 마트 간의 도급/위탁 용역 계약이 만료 또는 해지되는 경우, 본 근로계약도 별도의 해고 절차 없이 자동으로 종료(퇴직)된다"* 는 자동 퇴직 특약
2. 위 특약을 취업규칙 제10장(퇴직 및 해고) 및 근로계약서 특약으로 명시하여 부당해고 분쟁을 법적으로 사전 방어하도록 조치해라.
