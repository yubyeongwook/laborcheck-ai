...
export default function Home() {
  ...
  const handleFileUpload = (e) => {
    ...
    if (file) {
      ...
      if (!isChatActive) {
        ...
        startChatWithSecretary(`[📎 첨부파일: ${file.name}] 산재 진단서 및 급여 서류 AI 분석 요청`);
      }
    }
  };
  ...
  const startChatWithSecretary = (userInitialPrompt) => {
    ...
    if (initialText.includes('산재') || initialText.includes('진단서') || initialText.includes('다침') || initialText.includes('첨부파일')) {
