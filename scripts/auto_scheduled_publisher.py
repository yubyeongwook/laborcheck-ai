...
# 다양한 노무 이슈 및 라이브러리 (오전, 점심, 저녁 슬롯별 주제 대폭 확장)
HIGH_TRAFFIC_TOPICS = [
    # 산재보상 시리즈
    {
        "slot": "morning",
    ...
    },
    {
        ...
        "summary_1": "직장 내 괴롭힘으로 발생한 정신질환 산재 승인 가율 증가",
        ...
        "p3": "정신건강의학과 전문의의 소견서를 첨부하여 근로복지공단에 요양급여 신청서를 접수하면 공단 특별심의위원회를 거쳐 승인됩니다.",
...
CATEGORY_IMAGE_POOL = {
    ...
    "4대보험": [
        ...
        "https://images.unsplash.com/photo-1634733988138-bf2c3a2a13fa?auto=format&fit=crop&w=1200&q=80",
        "https://images.unsplash.com/photo-1521791055366-0d553872952f?auto=format&fit=crop&w=1200&q=80",
    ],
}
