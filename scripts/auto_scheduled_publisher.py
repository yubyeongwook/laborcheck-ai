...
# (2026-08-20: 여기 있던 중복 HIGH_TRAFFIC_TOPICS 정의는 아래쪽에서 같은 이름으로
#  다시 정의되어 완전히 가려지는 죽은 코드였음. 직장내괴롭힘·성희롱/육아휴직·출산휴가/
#  알바·단기직 노무/취업규칙·노동청점검/법정의무교육/직종별 맞춤노무 6개 카테고리 주제는
#  아래쪽 실제 HIGH_TRAFFIC_TOPICS 목록으로 옮겨서 실제로 발행되도록 함)
...
CATEGORY_TO_LAW = {
    ...
    "직종별 맞춤노무": (["근로기준법"], ["휴게", "근로시간", "교대", "야간근로"]),
    "퇴직금": (["근로기준법", "근로자퇴직급여 보장법"], ["퇴직금", "퇴직급여", "평균임금", "퇴직연금"]),
}
...
제목/소제목 톤: 네이버 및 구글실제 검색창에 사용자가 입력하는 [핵심 검색 키워드]를 제목 맨 앞에 배치하세요.
(예: "[퇴직금 계산기] 육아휴직 기간 재직일수 포함 여부 팩트체크", "[2026 최저임금] 10320원 209시간 월급 실수령액 정산", "[부당해고 예고수당] 5인 미만 사업장 30일분 수당 청구법").
...
{{
  ...
  "base_title": "핵심 검색 키워드가 맨 앞에 위치한 검색의도형 제목 (20~40자)",
